...
def case9():
    ...
    # Adding a pseudo bus #10 between bus #4 and bus #5 for injecting a transmission
    # line fault in branch id 8 by splitting the line into two equal lines
    ppc["branch"] = array([
        ...
        [4, 10, 0.005,   0.0475,  0.088, 250, 250, 250, 0, 0, 1, -360, 360],
        [10, 5, 0.005,   0.0475,  0.088, 250, 250, 250, 0, 0, 1, -360, 360]
    ])
